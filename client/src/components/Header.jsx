...
import image from './../assets/Screenshot 2024-07-17 121638.png';
  ...
  return (
    <header className="">
     <nav class="fixed top-0 left-0 w-full h-auto bg-gray-800 z-10 flex items-center justify-around">
      ...
      <h3 className="relative heading font-bold md:basis-1/6 text-2xl xs:basis-4/12 z-50 mb-5 mt-5">Info-Sphere</h3>
      <div style={{ position: "relative" ,display:"flex" , top:"10px",left:"330px",marginTop:"0px" }}><Search /></div>
